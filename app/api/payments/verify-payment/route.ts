...
async function createInvoiceAfterPayment(orderData: any, paymentDetails: any) {
  try {
    ...
    // Define plan details
    const plans = {
      starter: { name: 'Starter Plan', price: 12, priceINR: 999 },
      growth: { name: 'Growth Plan', price: 30, priceINR: 2499 },
      scale: { name: 'Scale Plan', price: 108, priceINR: 8999 }
    };
    ...
    const baseAmount = isIndianVisitor ? plan.priceINR : plan.price;
