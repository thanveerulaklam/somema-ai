        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form className="space-y-6" onSubmit={handleEmailLogin}>
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                loading={loading}
            ...
            <div className="mt-8">
              ...
              <div className="mt-6">
                <Button
                  variant="outline"
                  className="w-full h-12 border-gray-200 hover:bg-gray-50 hover:border-gray-300 rounded-xl font-medium text-base transition-all duration-200"
