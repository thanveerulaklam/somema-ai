      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Somema AI</h3>
            <p className="text-gray-300 mb-4">
              AI-powered social media management platform that helps businesses create, 
              schedule, and publish engaging content to Facebook and Instagram.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/pricing-policy" className="text-gray-300 hover:text-white transition-colors">
                  Pricing Policy
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 Somema AI. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/pricing-policy" className="text-gray-300 hover:text-white text-sm transition-colors">
                Pricing
              </Link>
