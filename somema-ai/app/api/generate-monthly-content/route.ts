      ...
      try {
        ...
        for (const img of selectedImages) {
          if (img.mime_type && img.mime_type.startsWith('video/')) {
            hasVideos = true
            console.log(`🎥 Video detected in monthly content: ${img.file_name} - skipping analysis`)
        ...
        if (hasVideos) {
          ...
          console.log('🎥 Generating video content directly from business profile for monthly post')
