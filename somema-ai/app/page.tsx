        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
              ...
              <span className="text-indigo-600"> Social Media Content Creation</span>
              <br />
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto">
              Quely.ai transforms your business by automatically creating engaging Facebook and Instagram content from your product images. Get back 10+ hours per week while your AI-powered posts drive more sales and followers. Focus on what matters - growing your business, not managing social media.
            </p>
