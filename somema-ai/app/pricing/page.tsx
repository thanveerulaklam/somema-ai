...
const topUps = [
  { id: 'enhancement-25', name: '+25 image enhancements', price: 12, priceINR: 999, priceUSD: 19 },
  { id: 'enhancement-100', name: '+100 image enhancements', price: 40, priceINR: 3299, priceUSD: 59 },
  { id: 'enhancement-250', name: '+250 image enhancements', price: 80, priceINR: 6599, priceUSD: 129 }
];
...
export default function PricingPage() {
      ...
      try {
        ...
        switch (countryCode) {
          case 'IN':
            ...
            break;
          default:
            console.log('🇺🇸 International visitor - setting USD');
  ...
  const handleTopUp = async (topUpId: string, price: number, priceINR: number, priceUSD: number) => {
    setLoading(topUpId);
              ...
              <div className="text-center mb-8">
                ...
                <div className="mb-4">
                  <span className="text-4xl font-bold text-gray-900">
                    {formatPrice(
                      isIndianVisitor ? plan.priceINR[billingCycle] :
                ...
                {billingCycle === 'yearly' && (
                  isIndianVisitor ? plan.priceINR[billingCycle] > 0 :
                  plan.priceUSD[billingCycle] > 0
                ) && (
            ...
            {topUps.map((topUp) => (
              <div key={topUp.id} className="border rounded-lg p-6 text-center">
                ...
                <p className="text-2xl font-bold text-blue-600 mb-2">
                  {formatPrice(
                    isIndianVisitor ? topUp.priceINR :
                    topUp.priceUSD
                  )}
                </p>
                                  <button
                    onClick={() => handleTopUp(topUp.id, topUp.price, topUp.priceINR, topUp.priceUSD)}
