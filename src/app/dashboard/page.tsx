          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs font-semibold ${metaConnected.instagram ? 'text-green-600' : 'text-gray-500'}`}>{metaConnected.instagram ? `Connected${metaConnected.instagramName ? ` as @${metaConnected.instagramName}` : ''}` : 'Not connected'}</span>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs font-semibold ${metaConnected.facebook ? 'text-green-600' : 'text-gray-500'}`}>{metaConnected.facebook ? `Connected${metaConnected.facebookName ? ` as ${metaConnected.facebookName}` : ''}` : 'Not connected'}</span>
              </div>
            </div>
          </div>
        </div>
